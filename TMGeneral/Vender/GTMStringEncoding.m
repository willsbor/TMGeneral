...
+ (id)stringEncodingWithString:(NSString *)string {
    NSString *__autoreleasing result = [[self alloc] initWithString:string];
  return result;
}
...
- (NSString *)encode:(NSData *)inData {
  ...
  [outData setLength:outPos];
    NSString *__autoreleasing result = [[NSString alloc] initWithData:outData
...
- (NSString *)stringByDecoding:(NSString *)inString {
  NSData *ret = [self decode:inString];
    NSString *__autoreleasing result = [[NSString alloc] initWithData:ret
